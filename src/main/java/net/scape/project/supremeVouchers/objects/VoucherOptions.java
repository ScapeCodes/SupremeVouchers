...
public class VoucherOptions {
    ...
    public VoucherOptions(boolean confirmUseEnable, String confirmUseMessage, boolean allowedWorldsEnable, List<String> allowedWorlds, String allowedWorldsMessage) {
